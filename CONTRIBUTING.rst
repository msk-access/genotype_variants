...
genotype_variants could always use more documentation, whether as part of the
official genotype_variants docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.9, 3.10, and 3.11. Check
   the GitHub Actions workflow and make sure that the tests pass for all supported Python versions.
